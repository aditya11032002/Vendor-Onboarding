  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-slate-950">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-200/50 shadow-sm rounded-2xl p-8">
        ...
        {/* Error Alert Block */}
        {error && (
          <div className="mb-6 p-4 rounded-xl bg-rose-50 border border-rose-100 text-rose-600 text-xs flex items-start gap-2.5 animate-shake">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider" htmlFor="username">
              Username
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-50/50 border border-slate-200/60 text-slate-800 rounded-xl py-3 pl-11 pr-4 text-xs placeholder-slate-400 focus:outline-none focus:border-slate-300 focus:bg-white transition-all font-medium"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-50/50 border border-slate-200/60 text-slate-800 rounded-xl py-3 pl-11 pr-12 text-xs placeholder-slate-400 focus:outline-none focus:border-slate-300 focus:bg-white transition-all font-medium"
              />
              <button
                type="button"
        ...
        {/* Footer info */}
        <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-between text-[10px] text-slate-400 font-bold tracking-wider uppercase">
