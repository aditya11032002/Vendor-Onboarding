...
export default function UsersSettings({ token }) {
  ...
  const [role, setRole] = useState('Approver L1');
          ...
          <form onSubmit={handleCreateUser} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                >
                  <option value="Approver L1">Approver L1 (First-Level Reviewer)</option>
                  <option value="Approver L2">Approver L2 (Senior/Final Approver)</option>
